...
module.exports  = () => {
    ...
    function  addNextPrev(counter, hasNext) {
        return (`\n<br/><hr /><hr /><div class="verybottom" >`+
                     ...
                     '<div class="verybottom" ><div class="page-footer"><a href="https://github.com/nurulc/tryitjs" target="_blank"><i class="tiny black">Built with TryITjs</i> <i class="small red external alternate icon"></i></a></div></div><br><br>'
        );
    }
