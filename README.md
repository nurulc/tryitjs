...
npm install -g tryitjs
```
#### If you have an existing npm module

```sh
cd to-your-project-directory
tyritjs --init
```
The command above will install update your ```package.json``` with dependencies and
startup file necessary to get started with the project.

The files and directories that will be added are as follows:
- try_src __a directory for your .try files__
- try_it  __a directory where the generated HTML file will be placed__

#### How to test

The following command will start up a web server to view your HTML tutorial file generated by tryit js
